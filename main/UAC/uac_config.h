...
#define SPEAK_CHANNEL_NUM    UAC_SPEAK_CHANNEL_NUM    /*!< SPEAKER */
#define MIC_CHANNEL_NUM      UAC_MIC_CHANNEL_NUM      /*!< MIC */
#define DEFAULT_SAMPLE_RATE  UAC_DEFAULT_SAMPLE_RATE  /*!< SAMPLE RATE */
#define SPK_INTERVAL_MS      UAC_SPK_INTERVAL_MS      /*!< READ INTERVAL in ms*/
#define MIC_INTERVAL_MS      UAC_MIC_INTERVAL_MS      /*!< WRITE INTERVAL in ms*/
